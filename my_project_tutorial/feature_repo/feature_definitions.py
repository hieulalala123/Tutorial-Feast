...
project = Project(name="my_project_tutorial", description="A project for driver statistics")
...
driver_stats_fv = FeatureView(
    ...
    schema=[
        ...
        Field(
            name="driver_profile",
            dtype=Struct({"name": String, "age": Int64}),
...
driver_stats_fresh_fv = FeatureView(
    ...
    schema=[
        ...
        Field(name="driver_profile", dtype=Struct({"name": String, "age": Int64})),
    ],
    online=True,
